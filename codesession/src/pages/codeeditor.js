...
export default class CodeEditorPage extends Component {
  ...
  changeLineNum(lineNum){
    // if(lineNum && !this.state.gutter) {
    //   this.setState({gutter: true})
    // }
    this.setState({lineNum})
}

changeGutter(gutter){
  if(!gutter){
    this.setState({lineNum: false})
  }else if(gutter && this.state.lineNum){
    this.setState({lineNum: true})
  }
  ...
  fullScreenEditor(){
    this.myCodeEditor.select().toggleClass('full-screen');
  }
    ...
    return (
      ...
      <div className="container">
        ...
        <FormControlLabel
          ...
          control={
            <Checkbox
              checked={this.state.lineNum}
              onChange={(e) => this.changeLineNum(!this.state.lineNum)}
              name="lineNum"
              color="primary"
            />
          }
        ...
        <FormControlLabel
          ...
          control={
            <Checkbox
              checked={this.state.gutter}
              onChange={(e) => this.changeGutter(!this.state.gutter)}
              name="gutter"
              color="primary"
            />
          }
      ...
      <Typography id="label">Font Size</Typography>
        ...
        <TextField id="filled-basic" inputProps={{readOnly:true}} hidden value={window.location.href} readOnly  inputRef={(textarea) => this.textArea = textarea}/>
        
        <Button variant="contained" onClick={this.goFull}>
              Go Fullscreen
            </Button>
        <Fullscreen
